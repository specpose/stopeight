...
\begin{align}
\mathrm{d} \gamma (t) = \gamma(t) \begin{bmatrix} \frac{\partial}{\partial t} \mathrm{d} t & \frac{\partial}{\partial x}  \mathrm{d} x & \frac{\partial}{\partial y} \mathrm{d} y \end{bmatrix} \frac{1}{\mathrm{d}t}
\end{align}
