...
\begin{equation}
C_{4} = \{C_{4} \in T_{4} \mid \max_{U}\lvert curvature(a,b) \rvert \cap (\inf_{t \in U} \lvert \frac{\mathrm{d}}{\mathrm{d}t}\gamma(t) \rvert \approx 0) \}
\end{equation}
...
\begin{equation}
T_{4} \subseteq \inf_{t \in U} \lvert \frac{\mathrm{d}^2}{\mathrm{d}t^2}\gamma(t) \rvert \approx 0
\end{equation}
...
\end{align}
\subsection{Swell}
Swell $\supset$ Crest $\supset$ Swing $\not \supset$ Spike\\
