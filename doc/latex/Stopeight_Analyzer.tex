...
\begin{align}
s_{alt} = \sum_{\mu_{+}}^{}dir -  \sum_{\mu_{-}}^{}dir
\end{align}
The fliping signs of times across measure spaces?
\begin{equation}
s_{times} = \prod_{measures} dir
\end{equation}
...
\begin{align}
\eta_{+}=(\{[a,b] \subseteq A,B \vert a<b\}) \Leftrightarrow dir=+1
\end{align}
Note: $\eta$ is a Lebesgue.
\begin{equation}
isolation(a,b)=dir \prod_{\lvert \mu \rvert \approx (b-a)}^{} straightness_{Abs}(a,b)
\end{equation}
