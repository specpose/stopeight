...
\subsection{Straight}
A Straight is a segment $[a,b]$ where $straightness(a,b)$ is smaller than the straightness of the unit circle (or curvature of exp?). It is not a proper section type, but merely an expression of being part of a Spike, or transfering the Straight half of a Dune to an adjacent ZigZag, or being used as part of Dune detection. It implies a reduction of measures which are smaller than the threshold. A Corner is $inserted$ at $\frac{b-a}{2}$.
\begin{equation}
Max_{Straight}=
\end{equation}
...
Dist_{Straight}=
\end{equation}
It is only used as an $insertion$ section, and if no more entities are being found. It occurs in the lowest priority of analysis (i.e. as a section of a whole Turn, where a=S and b=E) or as forward/backward parts of a Spike.\\
...
When the direction of analysis is reversed, the curve areas lie on the other side, therefore the direction inverts visibility.
\begin{align}
