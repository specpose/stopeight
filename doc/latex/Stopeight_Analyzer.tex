...
\end{align}
There are two main criteria among which the waves can vary. The absolute measure for source separation is visibility and isolation. They occur periodically and imply a reduction of the measure space.
...
\end{equation}
The orientation $o$ of a (sub-)manifold. The directed waves of straightness and curvature going forward/backward synchronously are periodic. (Not the changing signs of times)
