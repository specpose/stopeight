...
For Crests / Swell.
\begin{align}
z =  (\xi(t)-\iota_{X}(t))*(\cos{(visibility([a,b]))} +\mathrm{i} \sin{(\mathrm{i} isolation([a,b]))})\\
\end{align}
...
For Dune/Spiral.
\begin{align}
z =  \sup_{U}\lvert curvature([a,b]) \rvert*(\cos{(curvature([a,b]))} +\mathrm{i} \sin{(curvature([a,b]))})
\end{align}
\subsection{Lightning}
Superconductor\\
For Spike/ZigZag.
\begin{align}
z =  straightness([a,b]) + \mathrm{i} straightness([a,b])
\end{align}
