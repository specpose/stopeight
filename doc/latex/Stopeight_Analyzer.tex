...
Nervertheless the direction of analysis $o$ is preserved in the sign for both straightness and curvature.
\begin{align}
...
\end{align}
The diameter is also based on the metric (12) of $\iota_{T}$. Sign changes in the direction of analysis.
\begin{equation}
