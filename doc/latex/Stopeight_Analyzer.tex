...
\end{align}
or being used at lowest priority of computation to replace a curved $\{S,C,E\} \subset T$ with a straight one. The Corner $C_{4} \in U_{m }\subset X,Y,A$ is $replaced$ with $C_{4} \in Z,A; C_{4} \notin X,Y$.
\begin{align}
