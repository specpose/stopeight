...
\begin{equation}
ori(a,b')=0\land ori(b',c)=0
\end{equation}
If $b'$ is not in the in the Vector Graph $X$, it has to be approximated in the transversality $Z$ by linear regression of $X$. It is of highest computational priority.\\\\
