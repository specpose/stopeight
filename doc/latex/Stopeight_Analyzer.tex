...
Notation: The orientation $ori$ of a point, relative to the x-axis is not to be confused with the notion of an oriented manifold, which depends on the analytic direction $dir$.
