...
Binomial.
\begin{align}
\frac{\mathrm{d}^2}{\mathrm{d}t}\gamma(t)=\frac{\partial^2}{\mathrm{d}t} \gamma(t) \begin{bmatrix} \frac{\mathrm{d}x^2}{\partial x^2} & 2 \frac{\mathrm{d}x\mathrm{d}y}{\partial x \partial y} & \frac{\mathrm{d}y^2}{\partial y^2}\end{bmatrix}
\end{align}
Or Trinomial.
\begin{align}
