...
\subsection{Straight}
A Straight is a segment $[a,b]$ where $straightness(a,b)$ is smaller or equal to the ratio of the corresponding arc-length of two regular-polygon sides in a circle to the length of the direct line $\mathcal{C}$. Choosing the polygon $n\geq 2$ is subject to the underlying pen-tablet or signal analog to digital converter. It is a part of an Edge,
\begin{align}
Max_{Straight}=\frac{4\pi r / n}{\mathcal{C}}
\end{align}
