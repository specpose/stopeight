...
\begin{equation}
diameter(a,b)= o \lvert \iota_{T}(b) - \iota_{T}(a) \rvert
\end{equation}
...
\begin{align}
straightness_{Abs}(a.b)=\int \limits _{a}^{b}o \frac{\lvert \iota_{X}(t) - \iota_{T}(t) \rvert}{\lvert \xi(t) - \iota_{T}(t) \rvert} \mathrm{d}t\\
straightness_{Rel}(a,b)=\frac{\int \limits _{a}^{b} \lvert \iota'_{X}(t) \rvert \mathrm{d}t}{diameter(a,b)}\\
\end{align}
...
area_{h}(a,b)=\int \limits _{0}^{(b-a)/2} \lvert \xi(b-t)-\xi(a+t) \rvert \mathrm{d}t
\end{align}
\iffalse
\subsubsection{Algorithm Version}
...
\begin{align}
curvature_{Abs}(a,b) = \frac{area_{h}(a,b)}{\lvert \iota_{X}(b-t)-\iota_{X}(a+t)\rvert}\\
curvature_{Rel}(a,b) = \frac{\int \limits _{a}^{b} \lvert \xi'(t) \rvert \mathrm{d}t}{diameter(a,b)}
\end{align}
