...
\end{align}\\
The second order total derivative induces directionality. (product rule)
\begin{align}
\frac{\mathrm{d}^2}{\mathrm{d}t^2}\gamma(t)= \gamma(t) \begin{bmatrix} \frac{\partial^2}{\partial x^2}\frac{\mathrm{d}x}{\mathrm{d}t} & \frac{\partial}{\partial x}\frac{\mathrm{d}^2x}{\mathrm{d}t^2} & \frac{\partial^2}{\partial y^2}\frac{\mathrm{d}y}{\mathrm{d}t} & \frac{\partial}{\partial y}\frac{\mathrm{d}^2y}{\mathrm{d}t^2}\end{bmatrix}
\end{align}
