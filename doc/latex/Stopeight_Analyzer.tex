...
The curve of gamma can be interprated as a function $\gamma(t,x(t),y(t)$. The derivative is the total derivative.
\begin{align}
...
(HickHack/Bogen)
\begin{equation}
straightness(a.b)=\int \limits _{a}^{b}o \lvert \frac{\iota_{X}(t) - \iota_{T}(t)}{\xi(t) - \iota_{T}(t)}\rvert \mathrm{d}t
\end{equation}
Please take note of the sign here. The numerator and denominator have the same sign.
\iffalse
...
\begin{equation}
area(a,b)=\int \limits _{a}^{b} \xi'(t)-\iota'_{T}(t) \mathrm{d}t
\end{equation}
\iffalse
\subsubsection{Algorithm Version}
...
\begin{equation}
diameter(a,b)= \iota_{T}(b) - \iota_{T}(a)
\end{equation}
