...
\subsection{Dune}
A Dune $[a,b',c]$ is a curved segment $[a,b']$, which is followed by a maximal Straight section $[b',c]$. It is part of the Edge detection.
\begin{equation}
...
\subsection{ZigZag}
ZigZag $\supset$ Spike\\
The Spikes are Corners which become Turns one by one in each subsegment under the condition $straightness(a,b) \approx 1$ and $curvature(a,b)>Max_{Curve}$.
