...
$C_{4}$ is the Corner of the Spiral section, but the Spiral as a whole has an infinite amount of Corners, which are indexed differently (See Parametrised Corner Differences).
\subsection{ZigZag}
ZigZag $\supset$ Spike\\
...
If we have $T_{3}$ and all the Compact Covers worked out, Corners can be redefined (Swell?). $n$ supremums are considered over the whole section of the Compact Cover $V_{n}$.
\begin{equation}
