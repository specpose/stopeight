...
Please take note of the orientation here. (product? alternating?)
\begin{equation}
ori = \frac{dsi(a,b)}{\lvert dsi(a,b) \rvert}(?)
\end{equation}
The sum of a function over a measure space.\\
\begin{equation}
signs(\mu_{+},function)= \sum \limits _{\inf \limits _{\mu_{+}} (b-a)}^{\sup \limits _{\mu_{+}} (b-a)} function(a,b)
\end{equation}
The product of a function over a measure space.
\begin{equation}
...
\begin{align}
visibility(a,b)=dsi * signs(\mu,area(a,b)-\mathcal{Q}(a,b))(?)\\
visibility(a,b)=times(\mu,curvature(a,b)-\mathcal{Q}(a,b))(?)\\
\end{align}
\subsection*{Cases}
...
\begin{align}
isolation(a,b)=dir * times(\mu,straightness)(?)
\end{align}
