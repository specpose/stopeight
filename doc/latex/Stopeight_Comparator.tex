...
\begin{equation}
separation(a,b) = isolation + \mathrm{i} visibility(a,b)
\end{equation}
This can be calculated while resampling. (See Grapher)\\\\
...
\begin{align}
periodicity(a,b) =  (\xi(t)-\iota_{X}(t))*(visibility(a,b) +\mathrm{i} isolation(a,b))
\end{align}
