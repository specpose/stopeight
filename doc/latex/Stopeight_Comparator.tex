...
\begin{align}
isolation(a,b)= \int \limits _{a}^{b} \lvert \vartheta (x(t)+\mathrm{i}y(t)) \frac{\mathrm{d}}{\mathrm{d}t}\rvert \mathrm{d}t\\
...
\begin{align}
visibility(a,b)=\int \limits _{a}^{b} \upsilon (x(t)+\mathrm{i}y(t)) \mathrm{d}t\\
...
\begin{align}
\frac{\log isolation_{\iota_{X}}}{dir_{Y}\log\overline{\vartheta (SVE')}} \odot \frac{visibility_{\xi}}{\overline{\upsilon (VE)}+\mathrm{i}\overline{y(\upsilon (VC))}}
\end{align}
