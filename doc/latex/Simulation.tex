...
It could make sense to map such phenomena in a complex plane. Could we explain why for example a Crest starts appearing on a Reef, and different, purely imaginative waveforms appear in open ocean waters where waves travel in arbitrary directions.
